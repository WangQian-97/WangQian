...
<link href="${path }/resources/css/style.css?v=4.1.0" rel="stylesheet">
	...
	<!-- echarts -->
	<div class="modal fade" id="modal_in_echarts" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
	...
	<!-- 导入 -->
	<div class="modal fade" id="modal_in_edit" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					...
					<form id="form_user" method="post" action="reserveStudent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>班级：</td>
								<td colspan="4">
									<select class="form-control" name="bid" id = "roleid" aria-required="true" required>
							...
							<tr>
								...
								<td colspan="4">
									<input type="checkbox" name="hobbys" value="斗地主">斗地主
									<input type="checkbox" name="hobbys" value="填大坑">填大坑
									<input type="checkbox" name="hobbys" value="打麻将">打麻将
									<input type="checkbox" name="hobbys" value="510凯">510凯
								</td>
								<td colspan="2">
									 生日：<input type="date" id="birthdayid" name="birthday">
									 照片：<input type="file" name="picFile">
								</td>
							</tr>
						</table>
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_in").click(function(){
	    		$("#form_in").resetForm();
	    		$('#modal_in_edit').modal({backdrop: 'static', keyboard: false});
				$('#modal_in_edit').modal('show');
	        });
	        
	    	  //柱状图
	    	$("#btn_bar").click(function(){
	    		$('#modal_in_echarts').modal({backdrop: 'static', keyboard: false});
				$('#modal_in_echarts').modal('show');
	        });
	...
	function initEditUser(getSelection){
		...
		$('#birthdayid').val(new Date(getSelection.birthday).Format('yyyy-MM-dd'));
