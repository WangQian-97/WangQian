...
<body class="gray-bg">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_in" method="post" action="inPerson.htm" enctype="multipart/form-data">
					...
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td colspan="4">
									入职时间：<input type="date" name="jointime" id="jointimeid">
								</td>
							</tr>
						</table>
   ...
   /*  //外部js调用
				...
				$.ajax({
				    ...
				    success:function(res){
				    	...
				    	for(var i =0;i<list.length;i++){
				    		xdata[i]= list[i].mingcheng;
				    		ydata[i]= list[i].shuliang;
				    	}
	    	  ...
	    	  //饼状图
				...
				$.ajax({
				    ...
				    success:function(res){
				    	...
				    	for(var i =0;i<list.length;i++){
				    		xdata[i]= list[i].mingcheng;
				    		ydata[i]= {value:list[i].shuliang,name:list[i].mingcheng};
				    	}
				    	   //饼状图
				    	var myChart = echarts.init(document.getElementById('bar'));
				    	  option = {
	...
	function initEditUser(getSelection){
		...
		$('#jointimeid').val(new Date(getSelection.jointime).Format('yyyy-MM-dd'));
	}
